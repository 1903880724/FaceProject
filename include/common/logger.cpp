...
LogStreamConsumer gLogVerbose{LOGVERBOSE(gLoggerSample)};
LogStreamConsumer gLogInfo{LOGINFO(gLoggerSample)};
LogStreamConsumer gLogWarning{LOGWARN(gLoggerSample)};
LogStreamConsumer gLogError{LOGERROR(gLoggerSample)};
LogStreamConsumer gLogFatal{LOGFATAL(gLoggerSample)};
