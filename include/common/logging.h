...
//!
inline LogStreamConsumer LOGVERBOSE(const Logger& logger)
{
...
//!
inline LogStreamConsumer LOGINFO(const Logger& logger)
{
...
//!
inline LogStreamConsumer LOGWARN(const Logger& logger)
{
...
//!
inline LogStreamConsumer LOGERROR(const Logger& logger)
{
...
//!
inline LogStreamConsumer LOGFATAL(const Logger& logger)
{
